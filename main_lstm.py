...
if __name__ == "__main__":
    print("=" * 50)
    print(" Running OOP-Based LSTM Pipeline...")
    print("=" * 50)
    ...
    model = LSTMClassifier(vocab_size=1000, embed_dim=128, hidden_units=128, max_length=100, num_classes=1)
    ...
    print("\n[SUCCESS] LSTM Pipeline (OOP Standard) Completed Successfully!\n")